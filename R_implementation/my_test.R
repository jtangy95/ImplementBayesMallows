...
source("./my_tidy_mcmc.R")
source("./my_compute_mallows.R")
source("./my_plot.BayesMallows.R")
...
source("./my_compute_mallows_partial.R")
source("./my_tidy_mcmc_partial.R")
library(dplyr)
...
source("./my_compute_mallows_cluster.R")
source("./my_tidy_mcmc_cluster.R")
